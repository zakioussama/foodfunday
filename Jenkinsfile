    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                sh 'docker run --rm --volumes-from jenkins -v /home/oussama/foodfunday:/home/oussama/foodfunday -w /home/oussama/foodfunday foodfunday-ci bash -c "cp .env.example .env && php artisan key:generate && php artisan migrate --force && php artisan config:clear && php artisan cache:clear"'
            }
        }
    }
}
